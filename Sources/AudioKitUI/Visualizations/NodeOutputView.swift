...
public struct NodeOutputView: ViewRepresentable {
    ...
    public init(_ node: Node, foregroundColor: Color = .gray, backgroundColor: Color = .clear, bufferSize: Int = 1024) {

        metalFragment = FragmentBuilder(foregroundColor: foregroundColor.cg, backgroundColor: backgroundColor.cg, isCentered: true, isFilled: false)
